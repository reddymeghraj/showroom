...
erpnext.accounts.SalesInvoiceController = erpnext.selling.SellingController.extend({
	...
	payment_type: function(doc)
	{
		if(doc.payment_type=='Cash')
		{
			cur_frm.toggle_enable("mode_of_payment",true)
			cur_frm.toggle_enable("finance_name")
			cur_frm.toggle_enable("down_payment")
		}
		else{
			cur_frm.toggle_enable("mode_of_payment")
			cur_frm.toggle_enable("finance_name",true)
			cur_frm.toggle_enable("down_payment",true)
		}
	}
});
